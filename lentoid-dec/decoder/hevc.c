...
static lent_always_inline int decode_sps_ptl(HEVCContext *h, PTL *rpcPTL, Bool profilePresentFlag, Int maxNumSubLayersMinus1 )
{
	UInt uiCode;
	Int i;
...
static lent_always_inline int decode_vps(HEVCContext *h)
{
	UInt  uiCode;
	UInt i,opIdx;
	VPS *pcVPS;
